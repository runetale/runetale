...
func (q *Parsed) decode4(b []byte) {
	...
	q.Src = withIP(q.Src, ipaddr.IPv4(b[12], b[13], b[14], b[15]))
	q.Dst = withIP(q.Dst, ipaddr.IPv4(b[16], b[17], b[18], b[19]))
	...
	if fragOfs == 0 {
		...
		case ipproto.Fragment:
			// An IPProto valvue of 0xff (our Fragment constant for internal use)
